...
CREATE INDEX actions_action_type ON `actions` (`action_type`);
CREATE INDEX actions_user_id ON `actions` (`user_id`);

CREATE INDEX audit_logs_when ON `audit_logs` (`when`);
CREATE INDEX audit_logs_user ON `audit_logs` (`user`);

CREATE INDEX batches_marc_org_code ON `batches` (`marc_org_code`);
CREATE INDEX batches_created_at ON `batches` (`created_at`);
CREATE INDEX batches_status ON `batches` (`status`);
CREATE INDEX batches_went_live_at ON `batches` (`went_live_at`);
CREATE INDEX batches_archived_at ON `batches` (`archived_at`);

CREATE INDEX issues_marc_org_code ON `issues` (`marc_org_code`);
CREATE INDEX issues_lccn ON `issues` (`lccn`);
...
CREATE INDEX issues_workflow_step ON `issues` (`workflow_step`);
...
CREATE INDEX job_logs_log_level ON `job_logs` (`log_level`);
