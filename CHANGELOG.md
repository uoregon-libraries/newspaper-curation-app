...
(both staging and production), and it takes away the instructions and workflow
"pauses" for manually loading and purging batches. In most cases this should be
an easy trade-off, but it's certainly a big change.
...
- Major documentation overhaul, including information on the above-mentioned
  ONI Agent, but also typos were fixed, obsolete data removed, incorred
  information fixed, etc.
