...
// Do attempts to run the given function n number of times. Starting at
// 250ms, each failure increases the delay between it and the next try by 25%,
// up to a maximum of 5 seconds. Only the last error is returned. No matter
// what n is set to, the function will always be called at least once, making
// this safe to use with n=0.
//
