...
func (t *Transformer) makePNGFromPDF() bool {
	return shell.ExecSubgroup(t.GhostScript, "-dNumRenderingThreads=4", "-dNOPAUSE",
...
func (t *Transformer) makePNGFromTIFF() bool {
	return shell.ExecSubgroup(t.GraphicsMagick, "convert", "-background", "white",
		"-quality", "0", t.SourceFile, t.tmpPNG)
}

func (t *Transformer) makeJP2FromPNG(rate float64) bool {
	return shell.ExecSubgroup(t.OPJCompress, "-i", t.tmpPNG, "-o", t.tmpJP2, "-t",
...
func (t *Transformer) testJP2Decompress() bool {
	return shell.ExecSubgroup(t.OPJDecompress, "-i", t.tmpJP2, "-r", "4", "-o", t.tmpPNGTest)
}
