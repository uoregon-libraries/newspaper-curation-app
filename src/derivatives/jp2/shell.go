...
func (t *Transformer) makePNGFromPDF() bool {
	return shell.ExecSubgroupWithContext(t.GhostScript, t.Logger, "-dNumRenderingThreads=4", "-dNOPAUSE",
...
func (t *Transformer) makePNGFromTIFF() bool {
	return shell.ExecSubgroupWithContext(t.GraphicsMagick, t.Logger, "convert", "-background", "white",
		"-quality", "0", t.SourceFile, t.tmpPNG)
}

func (t *Transformer) makeJP2FromPNG(rate float64) bool {
	return shell.ExecSubgroupWithContext(t.OPJCompress, t.Logger, "-i", t.tmpPNG, "-o", t.tmpJP2, "-t",
...
func (t *Transformer) testJP2Decompress() bool {
	return shell.ExecSubgroupWithContext(t.OPJDecompress, t.Logger, "-i", t.tmpJP2, "-r", "4", "-o", t.tmpPNGTest)
}
